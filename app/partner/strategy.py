...
class NoTax(object):
    ...
    def pricing_policy(self, product, stockrecord):
        ...
        if self.user==None:
            ...
            discount = stockrecord.price_excl_tax * self.user.user_discount / 100
        return FixedPrice(
            currency=stockrecord.price_currency,
            excl_tax=stockrecord.price_excl_tax - discount,
            tax=D('0.00'))
...
class NoSkladView(StockRequired):
...
class PriceForSale(UseFirstStockRecord, NoSkladView, NoTax, Structured):
    pass
